 export const serverData = {
                ...
                entry_edge: {
                    ...
                    tier: 'entry-level',
                    models: [
                        { name: 'SYS-E100-9W', description: 'Mini servidor Edge fanless, ideal para IoT y aplicaciones embebidas.', url: 'https://www.supermicro.com/es/products/system/Box_PC/SYS-E100-9W-E.cfm' }
                    ]
                },
                ...
                mid_enterprise_virt: {
                    ...
                    models: [
                        ...
                        { name: 'AS-2024S-TR', description: 'Servidor rack 2U de doble socket AMD EPYC, diseñado para virtualización, aplicaciones de empresa y cargas intensivas de datos.', url: 'https://www.supermicro.com/en/products/system/2U/2024/AS-2024S-TR' }
                    ]
                },
                ...
                high_ultra: {
                    ...
                    tier: 'high-end',
                    models: [
                        { name: 'SYS-221H-TNR', description: 'Servidor Ultra 2U con doble procesador Intel Xeon Scalable, alta capacidad de memoria y múltiples ranuras PCIe 5.0 para máxima expansión.', url: 'https://www.supermicro.com/en/products/system/2U/221/SYS-221H-TNR' },
                ...
                high_twin: {
                    ...
                    tier: 'high-end',
                    models: [
                        { name: 'SYS-220GP-TNR', description: 'BigTwin 2U con 4 nodos frontales, cada uno con doble procesador Intel Xeon, ideal para despliegues de cómputo de alta densidad y HCI.', url: 'https://www.supermicro.com/en/products/system/2U/220GP/SYS-220GP-TNR' },
                        { name: 'SYS-F619P2-FT', description: 'FatTwin 4U con hasta 8 nodos, ofreciendo una densidad de cómputo y almacenamiento sin precedentes para centros de datos a gran escala.', url: 'https://www.supermicro.com/products/system/4U/F619/SYS-F619P2-FT.cfm' }
                    ]
                },
                high_storage_petascale: {
                    ...
                    tier: 'high-end',
                    models: [
                        { name: 'SSG-6049P-E1CR60L', description: 'Servidor de almacenamiento 4U con 60 bahías de carga superior, diseñado para almacenamiento de objetos a escala de petabytes.', url: 'https://www.supermicro.com/products/system/4U/6049/SSG-6049P-E1CR60L.cfm' },
                        { name: 'SSG-610P-ACR12N4L', description: 'Servidor de almacenamiento 1U All-Flash NVMe con 12 bahías U.2, ideal para bases de datos de alto rendimiento y almacenamiento de baja latencia.', url: 'https://www.supermicro.com/es/products/system/megadc/1u/ssg-610p-acr12n4l' }
                    ]
                },
                high_clouddc: {
